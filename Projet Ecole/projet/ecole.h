...
void RechercherEleve(ecole_t E, const char *son_nom,const char *son_prenom );//fonction pour rechercher un eleve dans l ecole en connaissant son prenom et son nom
//si cette fonction renvoie -1 il faudra renvoyer a la fonction saisir eleve
//eleve_t lui correspond a l eleve a rechercher
void sauvegarde(const ecole_t *E);//fonction pour sauvegarder l ecole dans un fichier
#endif
